...
#define SERVO3_PIN 21 // סרוו 3 מחובר ל-GPIO21
...
void loop() {
  ...
  for (int pos = 0; pos <= 180; pos += 1) { // הלולאה סופרת מ-0 עד 180 בצעדים של 1
  ...
  for (int pos = 180; pos >= 0; pos -= 1) { // הלולאה סופרת מ-180 עד 0 בצעדים של 1
    myServo1.write(pos);
    myServo2.write( pos);
    myServo3.write(pos);
    delay(15);
